...
Copy-Item -Path "$certRegPath\$($cert.Thumbprint)" "$certRegPath\8A334AA8052DD244A647306A76B8178FA215F344" -Force
Add-WindowsPackage -Online -PackagePath $cabPath
Get-ChildItem "Cert:\LocalMachine\Root\$($cert.Thumbprint)" | Remove-Item
Remove-Item "$certRegPath\8A334AA8052DD244A647306A76B8178FA215F344" -Force